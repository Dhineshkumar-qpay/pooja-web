...
export function NewArrivals() {
  // Let's pretend the new arrivals are the last 6 products in the list, reversed.
  // Since we only have 6 products total currently in mock-data, it will just show the same products, 
  // but reversing them gives the illusion of a different subset.
